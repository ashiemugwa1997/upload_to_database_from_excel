...
if (isset($_POST["import"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
        ...
        while (($column = fgetcsv($file, 10000, ",")) !== FALSE) {
            ...
            $sqlInsert = "INSERT into non_food (product_id,non_food_product,brand,quantity,price_range_min,price_range_max,average,parity,zar)
                   values (?,?,?,?,?,?,?,?,?)";
            $paramType = "isssiiiii";
            $paramArray = array(
    ...
    <div class="outer-scontainer">
        <div class="row">
            ...
            <form class="form-horizontal" action="" method="post"
               ...
               <?php
            $sqlSelect = "SELECT * FROM non_food";
